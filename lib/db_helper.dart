...
import 'package:safecatering/model/productdetails_model.dart';
...
///////remark table//////////////////////
  ...
  Future<Database> get database async {
    ...
    _database = await _initDB("safecatering.db");
    return _database!;
  }
...
////////////////////////insert remark/////////////////////////////////
  ...
  Future<List<Map<String, dynamic>>> getCustomer(
      String aid, String cusCode) async {
    ...
    if (aid == ' ' || aid.isEmpty) {
      ...
      hname = await db.rawQuery(
          'SELECT  hname,ac_code FROM accountHeadsTable WHERE area_id="${aid}" AND ac_code="${cusCode}" order by hname');
    }
