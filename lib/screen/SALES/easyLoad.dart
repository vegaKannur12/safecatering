...
import 'package:safecatering/screen/SALES/testPage.dart';

class EasyLoadExample extends StatefulWidget {
  const EasyLoadExample({Key? key}) : super(key: key);

  @override
  State<EasyLoadExample> createState() => _EasyLoadExampleState();
}

class _EasyLoadExampleState extends State<EasyLoadExample> {
  Timer? _timer;
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (BuildContext context) => TestP(),
                        ),
                      );
                    },
                  ),
