...
import 'package:safecatering/screen/ORDER/6.1_remarks.dart';
import 'package:safecatering/screen/ORDER/6_collection.dart';
import 'package:safecatering/screen/ORDER/X001_orderItemSelection.dart';
import 'package:safecatering/screen/RETURN/returnItemList.dart';
import 'package:safecatering/screen/SALES/X001Itemselection.dart';
...
class _OrderFormState extends State<OrderForm> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // if (Provider.of<Controller>(context, listen: false).dfcusCode != null) {
    //   customertext.text =
    //       Provider.of<Controller>(context, listen: false).dfCusName.toString();
    //   custmerId = Provider.of<Controller>(context, listen: false).dfcusCode;
    // }
    sharedPref();
  }
                                    ...
                                    child: Autocomplete<Map<String, dynamic>>(
                                      ...
                                      onSelected: (value) {
                                        setState(() {
                                          ...
                                          values.customertext.text = '';
                                          Provider.of<Controller>(context,
                                                  listen: false)
                                              .getCustomer(
                                                  _selectedAreaId,
                                                  values.settingsList1[0]
                                                      ["set_value"]);
                                          setState(() {});
                                          setState(() {
                                            print(
                                                "nnnn-----${values.dfCusName.toString()}");
                                            values.customertext.text =
                                                values.dfCusName.toString();
                                            custmerId = values.dfcusCode;
                                          });
                                        });
                                      },
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              suffixIcon: IconButton(
                                                onPressed: () {
                                                  fieldText.clear();
                                                  _selectedAreaId = ' ';
                                                  values.customertext.clear();
                                                  // Provider.of<Controller>(
                                                  //         context,
                                                  //         listen: false)
                                                  //     .getCustomer(
                                                  //         _selectedAreaId,
                                                  //         values.settingsList1[
                                                  //             0]["set_value"]);
                                                },
                                            ...
                                            return SizedBox(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  //                 listen: false)
                                                  //             .getCustomer(
                                                  //                 _selectedAreaId,values.settingsList1[0]["set_value"]);
                                                  //       } else {
                                                  //         print(
                                                  ...
                                                  //                     listen:
                                                  //                         false)
                                                  //                 .areaId,values.settingsList1[0]["set_value"]);
                                                  //       }
                                                  //     }
