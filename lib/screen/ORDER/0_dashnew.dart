...
import 'package:safecatering/screen/reports/sale_report.dart';
      ...
      case "1":
        {
          ...
          Provider.of<Controller>(context, listen: false)
              .todaySales(s[0], gen_condition!, "sale report");
      ...
      case "2":
        {
          ...
          Provider.of<Controller>(context, listen: false).setDate(s[0], "");
          Provider.of<Controller>(context, listen: false)
              .todaySales(s[0], gen_condition!, "upload history");
      ...
      case "3":
        {
          Provider.of<Controller>(context, listen: false).setDate(s[0], "");
          Provider.of<Controller>(context, listen: false)
              .todaySales(s[0], gen_condition!, "history pending");
