...
import 'package:safecatering/components/customSnackbar.dart';
import 'package:safecatering/components/sunmi.dart';
import 'package:safecatering/db_helper.dart';
import 'package:safecatering/model/accounthead_model.dart';
import 'package:safecatering/model/productCompany_model.dart';
import 'package:safecatering/model/productUnitsModel.dart';
import 'package:safecatering/model/productsCategory_model.dart';
import 'package:safecatering/model/registration_model.dart';
import 'package:safecatering/model/settings_model.dart';
import 'package:safecatering/model/sideMenu_model.dart';
import 'package:safecatering/model/userType_model.dart';
import 'package:safecatering/model/verify_registrationModel.dart';
import 'package:safecatering/model/wallet_model.dart';
import 'package:safecatering/screen/ADMIN_/adminModel.dart';
...
///////////////////////////////////////////////////////
  ...
  /////////////////////GET CUSTOMER////////////////////////////////
  getCustomer(String? aid, String cusCode) async {
    String arid;
    print("aid...............${aid}");
    try {
      ...
      customerList = await OrderAppDB.instance.getCustomer(arid, cusCode);
      ...
      dfCusName = custmerDetails[0]["hname"];
      dfcusCode = custmerDetails[0]["ac_code"];
      customertext.text = dfCusName.toString();
      notifyListeners();
    } catch (e) {
      print(e);
      return null;
...
//////////////////////////////////////////////////////////////
  printSales(
    ...
    printer.printReceipt(
        printSalesData, salesMasterData["payment_mode"], isCancelled);
...
//////////////////////////////////////
  setDropdowndata(String s, BuildContext context) async {
    ...
    for (int i = 0; i < branch_List.length; i++) {
      if (branch_List[i]["br_id"] == s) {
        branch_name = branch_List[i]["br_name"];
        br_id = s;
        SharedPreferences prefs = await SharedPreferences.getInstance();
        prefs.setString("br_id", s);
        ...
        br_id = prefs.getString("br_id");
        branch_name = prefs.getString("br_name");
      }
    }

    var res = await OrderAppDB.instance.updateRegistrationtable(br_addr_map);
    isLoading = false;
    print("s------$s");
    getCompanyData(context);
    //  Navigator.push(
